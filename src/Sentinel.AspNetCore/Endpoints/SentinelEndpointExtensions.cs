...
{
    /// <summary>
    /// Maps Sentinel Framework Security Endpoints (Auth, Token Exchange, SSF, Backchannel Logout) into the host application.
    /// </summary>
    ...
    /// </summary>
    public static RouteHandlerBuilder RequireAcrStepUp(this RouteHandlerBuilder builder, string requiredAcr = "acr3", TimeSpan? maxAuthAge = null)
