...
{
    private readonly Channel<NotificationMessage> channel = Channel.CreateBounded<NotificationMessage>(new BoundedChannelOptions(Math.Max(options.Value.QueueCapacity, 64))
    {
