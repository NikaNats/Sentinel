...
#pragma warning disable CA1031 // Do not catch general exception types
    ...
    {
        _logger.LogInformation("SecurityCacheCleanupService started. Running cleanup every {Interval} minutes.", CleanupInterval.TotalMinutes);
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            {
                _logger.LogError(ex, "Error during security cache cleanup cycle (operation will retry in {Interval} minutes)", CleanupInterval.TotalMinutes);
            }
